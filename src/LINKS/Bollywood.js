...
class Bollywood extends Component{
    ...
    render(){
        const user = {
          ...
          const icon = {
            name: 'Nature',
            down: 'https://th.bing.com/th/id/R.042aaf5131ea9d504fb3f6ea34d2d899?rik=%2fk0SSsk51qLirg&riu=http%3a%2f%2fwww.clipartbest.com%2fcliparts%2fdi7%2fLzn%2fdi7LzndxT.png&ehk=HSB2oNtARygfjc1T5iJnM1c86uhte0SsBHrSl7ifnU8%3d&risl=&pid=ImgRaw&r=0',
            imageSizewidth: 25,
            imageSizehight: 25,
          };
          const Latestst = {
 ...
 <nav className="formorgin">
           ...
           <div  className="Latestart"> Bollywood 
...
<div className="avatar" >
      ...
      <div className="aa1"> <nav>
      Catch waves with an adventure guide </nav><nav className="num">2</nav>
      </div>
<br/>
        Travel <span className="Travelleft"> / August 21 2017</span>
        </nav>
