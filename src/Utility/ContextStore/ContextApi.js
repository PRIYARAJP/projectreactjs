...
const ContextApi = (props) => {
    let [data, setData] = useState([
      ...
      {id:30, cat:"bollywood", img:"https://tse2.mm.bing.net/th/id/OIP.L9LSR1RnzLLWKgQ4B5PbOwHaK_?pid=ImgDet&rs=1",  heading:"Sivakarthikeyan " ,command:"Sivakarthikeyan is an Indian actor, lyricist, and television presenter predominantly working in the Tamil film industry12. He was born on February 17, 1985."},
      ...
      {id:37, cat:"hollywoodtop", img:"https://hdqwalls.com/download/1/thor-avengers.jpg", heading:"Battle of Sokovia" , command:"Ultron tries to use Sokovia as a meteor to induce an extinction event. "},    
      {id:38, cat:"hollywoodtop", img:"https://images3.alphacoders.com/605/605991.jpg", heading:"Civil War",command:"Months after the Battle of Sokovia, the Avengers' new facility becomes targeted in a heist, with a skirmish between Wilson and Scott Lang."},
